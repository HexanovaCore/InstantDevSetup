...
LOCALIZED_TEXTS = {
    "tr": {
        ...
        "more_info": "Daha fazla bilgi için alt komutların yanına da --help ekleyebilirsiniz. Örn: smp init --help",
    ...
    "en": {
        ...
        "more_info": "For more information, you can add --help next to subcommands. e.g., smp --help",
